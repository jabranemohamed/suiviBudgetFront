...
let chartJsCode = require('../../../assets/data/syntax/charts/chartJsCode.json');
...
export class ChartjsComponent {
    ...
    //Code Highlight
    lineChartJsCode: string
    stackAreaChartJsCode: string
    barChartJsCode: string
    radarChartJsCode: string
    pieChartJsCode: string
    doughnutChartJsCode: string
    polarChartJsCode: string
    bubbleChartJsCode: string
    chartJsAPICode: string
    ...
    ngOnInit() {
        ...
        //Code Highlight
        this.lineChartJsCode = chartJsCode.lineChartJsCode;
        this.stackAreaChartJsCode = chartJsCode.stackAreaChartJsCode;
        this.barChartJsCode = chartJsCode.barChartJsCode;
        this.radarChartJsCode = chartJsCode.radarChartJsCode;
        this.doughnutChartJsCode = chartJsCode.doughnutChartJsCode;
        this.polarChartJsCode = chartJsCode.polarChartJsCode;
        this.chartJsAPICode = chartJsCode.chartJsAPICode;
    }    
